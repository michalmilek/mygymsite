  ...
  return (
    <section
     ...
     bg-primary2 relative h-[700px]">
      <div className="absolute translate-x-[100vw] w-screen">
        <div className="">
          <img
      ...
      <div>
        <div className="">
          <img
            className="w-screen h-[700px] object-contain mix-blend-multiply"
      ...
      <button className="absolute top-[50%] translate-y-[-50%] left-[5%] cursor-pointer">
        <ArrowLeftIcon className="text-white opacity-30 font-bold opacity-1 mix-blend-darken h-[200px] w-[200px]" />
      </button>

      <button className="absolute top-[50%] translate-y-[-50%] right-[5%] cursor-pointer">
