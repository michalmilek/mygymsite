...
const Promo = (props: Props) => {
  ...
  return (
    <section
     ...
     bg-primary2 relative h-[700px] mix-blend-multiply">
      <m.div
        className={`${
          selected === 0 ? "translate-x-[0vw]" : "translate-x-[-100vw]"
        } w-screen absolute transition-all duration-500 before:mix-blend-multiply before:absolute before:w-vw before:h-[700px] before:top-0 before:left-0 before:content-['']`}>
