  ...
  return (
    <section className="w-screen bg-primary2 relative">
      <div className="absolute cursor-pointer">
        <ArrowLeftIcon className="absolute cursor-pointer text-white border-[10px] font-bold opacity-1 mix-blend-plus-lighter top-[50%] translate-y-[-50%] left-[5%] h-[200px] w-[200px]" />
