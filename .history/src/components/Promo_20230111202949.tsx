  ...
  return (
    <section className="w-screen bg-primary2 relative">
      ...
      <div className="absolute flex flex-col items-start gap-1 text-white left-[25%] top-[30%] font-raleway">
        ...
        <button className="px-6 bg-primary3 mix-blend-lighten hover:opacity-75 transition-all duration-350 bg-button url text-xl ml-[25%] py-4 border-[2px] border-white rounded-lg">
          Przekierowanie
        </button>
      </div>
    </section>
