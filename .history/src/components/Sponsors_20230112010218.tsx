...
const width = "w-[350px] object-fill mix-blend-multiply";

const Sponsors = (props: Props) => {
  return (
    <div className="bg-secondary1 font-raleway min-h-[400px] text-center pt-16">
      <h1 className="text-black text-7xl">Sponsors</h1>
      <div className="justify-center items-center flex gap-16">
        <img
