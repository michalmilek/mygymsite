    ...
    <section
     ...
     bg-primary2 relative h-[700px]">
      <AnimatePresence>
        <div
          className={`w-screen ${
            selected === 0 ? "translate-x-[0vw]" : "translate-x-[-100vw] hidden"
          ...
          <m.div className="absolute flex flex-col items-start gap-1 mix-blend-normal opacity-1 text-white left-[25%] top-[30%] font-raleway">
        ...
        <div
          className={`w-screen ${
            selected === 1 ? "translate-x-[0vw]" : "translate-x-[100vw] hidden"
          } absolute transition-all duration-500`}>
          <div className="mix-blend-multiply z-30 bg-primary2">
            <img
              className="w-screen h-[700px] object-cover object-top mix-blend-multiply"
          ...
          <m.div
            ...
            className="absolute flex flex-col items-start gap-1 mix-blend-normal opacity-1 text-white left-[25%] top-[30%] font-raleway">
        ...
        <div
          className={`w-screen ${
            selected === 2 ? "translate-x-[0vw]" : "translate-x-[-100vw] hidden"
          } absolute transition-all duration-500`}>
          <div className="mix-blend-multiply z-30 bg-primary2">
            <img
              className="w-screen h-[700px] object-cover object-top mix-blend-multiply"
        ...
        <div
          className={`w-screen ${
            selected === 3 ? "translate-x-[0vw]" : "translate-x-[100vw] hidden"
          } absolute transition-all duration-500`}>
          <div className="mix-blend-multiply z-30 bg-primary2">
            <img
              className="w-screen h-[700px] object-cover object-top mix-blend-multiply"
