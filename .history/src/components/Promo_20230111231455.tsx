    ...
    <section
     ...
     bg-primary2 relative h-[700px]">
      <div
        className={`${
          selected === 0
            ? "translate-x-[0vw] bg-primary2 bg-blend-multiply"
            : "translate-x-[-100vw]"
        } w-screen absolute transition-all duration-500`}>
        <div className="bg-primary2 bg-blend-multiply">
          <img
            className="w-screen h-[700px] relative object-cover"
