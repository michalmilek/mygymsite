...
const Promo = (props: Props) => {
  return (
    <section className="w-screen bg-primary2 relative mix-blend-multiply">
      ...
      <button className="absolute top-[50%] translate-y-[-50%] left-[5%] cursor-pointer">
        <ArrowLeftIcon className="text-white bg-primary2 border-[10px] font-bold opacity-1 mix-blend-darken h-[200px] w-[200px]" />
      </button>
