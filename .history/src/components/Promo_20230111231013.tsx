    ...
    <section
     ...
     bg-primary2 relative h-[700px]">
      <m.div
        ...
        } w-screen absolute transition-all duration-500 mix-blend-multiply`}>
        <div className="mix-blend-multiply z-30">
          <img
      ...
      <m.div
        ...
        } absolute transition-all duration-500 mix-blend-multiply`}>
        <div className="">
          <img
        ...
        <div className="absolute flex flex-col items-start gap-1 mix-blend-normal text-white left-[25%] top-[30%] font-raleway">
          <h1 className="text-7xl">Promocje!</h1>
          <p className="text-3xl">Zapoznaj się z naszymi promocjami!</p>
          <button className="px-6 mt-5 mix-blend-lighten hover:opacity-75 transition-all duration-350 bg-transparent text-xl ml-[25%] py-4 border-[2px] border-white rounded-lg">
            Przekierowanie
