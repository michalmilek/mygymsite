  ...
  return (
    <section
     ...
     bg-primary2 relative h-[700px]">
      <div className={`${selected === 0 ? "hidden" : ""} w-screen`}>
        <div className="">
          <img
      ...
      <div className={`${selected === 1 ? "hidden" : ""} w-screen`}>
        <div className="">
          <img
      ...
      <button
        ...
        onClick={() => (yle.transform = "translateX(-100vh)")}>
      ...
      <button
        ...
        onClick={() => (document.body.style.transform = "translateX(100vh)")}>
